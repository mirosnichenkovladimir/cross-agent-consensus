...
Append one AuthorResponse for every in-scope blocking material CanonicalFinding. ClarificationRecord sections may be added when a response requests clarification.
